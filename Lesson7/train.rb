...
class Train
  ...
  def show_railway_carriages # Выводить список вагонов у поезда
    @railway_carriages
  end

  def railway_carriages_to_block(&block) # блок
    @railway_carriages.each_with_index { |rc, i| block.call(rc, i) }
  end
